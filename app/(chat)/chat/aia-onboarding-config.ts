...
export const AIA_SETUP_VIDEO_URL = "https://youtu.be/TpDglmoa884";
export const AIA_SETUP_VIDEO_EMBED_URL =
  "https://www.youtube.com/embed/TpDglmoa884";
...
export const AIA_ONBOARDING_STEPS: AiaOnboardingStep[] = [
  ...
  },
  {
    ...
    body: "Download AI Accountant and install the Tally connector on the computer where your Tally company runs, exactly as shown in the video. Have you done that?",
    buttonLabel: "Yes, installed",
  },
  {
    id: "connect",
    title: "Connect your company",
    body: "Open AI Accountant, connect it to your Tally company (Blossom Retail Pvt Ltd, books beginning 1 April 2024) and run a first sync so it can see your ledgers. Is it connected?",
    buttonLabel: "Yes, connected",
  },
  {
    id: "monthly",
    title: "How each month works from now on",
    body: "1. Download the documents from the exercise message.\n2. Upload the vendor invoices and the bank statement to AI Accountant. For sales, upload the Sales Register CSV to its sales screen (it does not read the sales invoice PDFs; those are for you to check against).\n3. Review every voucher it proposes: ledger, side, amount, GST, bill reference. Fix anything wrong before you sync.\n4. Sync to Tally.\n5. Post the month-end notes by hand in Tally.\n6. Export the Day Book and Trial Balance and upload them here as usual.",
    buttonLabel: "Next",
  },
  {
    id: "scoring",
    title: "Scoring does not change",
    body: "Your Tally exports are what get evaluated, exactly as before. AI Accountant is a tool; what ends up in the books is still your responsibility, so check its vouchers before you sync. Written explanations continue in the chat for explain batches.",
    buttonLabel: "Start",
  },
];
