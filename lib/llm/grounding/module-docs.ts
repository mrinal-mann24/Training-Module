...
export const CONCEPT_TO_MODULE_DOC: Record<ConceptTag, string> = {
  ...
  customer_advance: '7.Receivables_Module',
  supplier_advance: '6.Payables_Module',
  on_account_reference: '6.Payables_Module',
  multi_bill_settlement: '6.Payables_Module',
  tds_on_receipt: '4.1 Taxation Module_1_TDS',
  gst_set_off: '4.2 Taxation Module_2_GST',
  gst_payment: '4.2 Taxation Module_2_GST',
  rcm_and_late_fee: '4.2 Taxation Module_2_GST',
  fixed_assets_depreciation: '5.Fixed_Assets_Module',
