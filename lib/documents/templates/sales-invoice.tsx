...
import { SalesInvoiceParticulars } from '@/lib/documents/templates/gst-particulars';
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.partyBlock}>
          ...
          <View style={styles.partyColumn}>
            ...
            <Text>
              Place of supply: {content.placeOfSupply}
              {content.placeOfSupplyCode ? ` (${content.placeOfSupplyCode})` : ''}
            </Text>
        ...
        <SalesInvoiceParticulars content={content} />
